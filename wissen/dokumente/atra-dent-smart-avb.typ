// Allgemeine Versicherungsbedingungen — atra.dent.smart
//
...
#show: avb-dokument.with(
  ...
  bedingungsnummer: "AVB SMART 01/2026",
  stand: stand-text,
...
#bildplatz(
  "/wissen/dokumente/bilder/avb-smart-auftakt.png",
  "Bild 4 — Auftakt smart",
  verhaeltnis: 2.4,
)
#bedingungswerk(t, bilder: (
    vertrag: (
      datei: "/wissen/dokumente/bilder/avb-smart-vertrag.png",
      motiv: "Bild 5 — Vertragsteil smart",
      verhaeltnis: 3.1,
    ),
  ), variante: none)
